...
var ActorImage = ({
  ...
  const bottomMaskStyle = (0, import_react.useMemo)(() => {
  ...
  const ghostFloatAnimation = (0, import_react.useMemo)(() => {
    if (!isGhost) {
      return null;
    }
    return {
  ...
  const hologramAlphaMaskStyle = (0, import_react.useMemo)(() => {
  ...
  return displayedImageUrl ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", { style: { position: "absolute", width: 0, height: 0, overflow: "hidden" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("defs", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("filter", { id: ghostTintFilterId, x: "-15%", y: "-15%", width: "130%", height: "130%", colorInterpolationFilters: "sRGB", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feFlood", { floodColor: filterColor, result: "ghostFlood" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feComposite", { in: "ghostFlood", in2: "SourceAlpha", operator: "in", result: "ghostMask" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feGaussianBlur", { in: "ghostMask", stdDeviation: "2.2", result: "ghostSoft" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("feMerge", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feMergeNode", { in: "ghostSoft" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feMergeNode", { in: "ghostMask" })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("filter", { id: auraGlowFilterId, x: "-40%", y: "-40%", width: "180%", height: "180%", colorInterpolationFilters: "sRGB", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feGaussianBlur", { in: "SourceAlpha", stdDeviation: "3.2", result: "auraBlur" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feFlood", { floodColor: filterColor, result: "auraFlood" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feComposite", { in: "auraFlood", in2: "auraBlur", operator: "in", result: "auraGlow" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feGaussianBlur", { in: "auraGlow", stdDeviation: "1.4", result: "auraSoft" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("feMerge", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feMergeNode", { in: "auraSoft" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feMergeNode", { in: "auraGlow" })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("filter", { id: hologramTintFilterId, x: "-25%", y: "-25%", width: "150%", height: "150%", colorInterpolationFilters: "sRGB", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feFlood", { floodColor: filterColor, result: "holoFlood" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feComposite", { in: "holoFlood", in2: "SourceAlpha", operator: "in", result: "holoMask" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("feGaussianBlur", { in: "holoMask", stdDeviation: "1.6", result: "holoSoft" }),
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          import_framer_motion.motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_framer_motion.AnimatePresence, { children: displayedImageUrl && imageFilter === "ghost" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                import_framer_motion.motion.img,
                {
                  src: displayedImageUrl,
                  initial: { opacity: 0 },
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_framer_motion.AnimatePresence, { children: displayedImageUrl && isHologram && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                import_framer_motion.motion.div,
                {
                  initial: { opacity: 0 },
                  animate: { opacity: 1 },
...
var MIN_FONT_SIZE_MULTIPLIER = 0.75;
var MAX_FONT_SIZE_MULTIPLIER = 1.5;
...
var PER_CHARACTER_INLINE_CLASSES = /* @__PURE__ */ new Set(["glitch", "flutter", "sigh", "zalgo", "arcane", "spooky", "quake", "whisper"]);
...
var renderBurnSegment = (segmentText, resolvedStyle, segmentKey, formatText) => {
  if (!/\S/.test(segmentText)) {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "burn", style: resolvedStyle, children: formatText(segmentText) }, segmentKey);
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "burn nv-inline-burning", style: resolvedStyle, children: [
...
var renderTearsSegment = (segmentText, resolvedStyle, segmentKey, formatText) => {
  if (!/\S/.test(segmentText)) {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "tears", style: resolvedStyle, children: formatText(segmentText) }, segmentKey);
  }
  const visibleCharacterCount = Array.from(segmentText).filter((character) => !/\s/.test(character)).length;
  const dropCount = Math.max(2, Math.min(6, Math.ceil(visibleCharacterCount / 4)));
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "tears nv-inline-tearful", style: resolvedStyle, children: [
...
var useVoiceAudio = (enabled, speechUrl, playbackKey, voiceModulation) => {
  ...
  const currentBufferSourceNodeRef = (0, import_react6.useRef)(null);
  const currentPitchShifterNodeRef = (0, import_react6.useRef)(null);
  const currentAudioAnalyserRef = (0, import_react6.useRef)(null);
  const currentAudioWarmthFilterRef = (0, import_react6.useRef)(null);
  const currentAudioBrightnessFilterRef = (0, import_react6.useRef)(null);
  const currentAudioNasalityFilterRef = (0, import_react6.useRef)(null);
  const currentAudioGainRef = (0, import_react6.useRef)(null);
  const audioLoadTokenRef = (0, import_react6.useRef)(0);
  const prevPlaybackKeyRef = (0, import_react6.useRef)(playbackKey);
  const [isAudioPlaying, setIsAudioPlaying] = (0, import_react6.useState)(false);
  const [audioAnalyser, setAudioAnalyser] = (0, import_react6.useState)(null);
  const normalizedModulation = (0, import_react6.useMemo)(() => normalizeVoiceModulation(voiceModulation), [voiceModulation]);
  const pitchShifterRatio = (0, import_react6.useMemo)(
    () => semitonesToRatio(normalizedModulation.pitch) / normalizedModulation.rate,
    [normalizedModulation]
  );
  const cleanupAudioGraph = (0, import_react6.useCallback)(() => {
  ...
  const applyModulationToGraph = (0, import_react6.useCallback)((modulation) => {
  ...
  const buildAudioGraph = (0, import_react6.useCallback)(async (audioBuffer, rate, pitchRatio, modulation) => {
...
function NovelVisualizer(props) {
  ...
  const [finishTyping, setFinishTyping] = (0, import_react7.useState)(false);
  const [messageKey, setMessageKey] = import_react7.default.useState(0);
  const [hoveredActor, setHoveredActor] = (0, import_react7.useState)(null);
  const [mousePosition, setMousePosition] = (0, import_react7.useState)(null);
  const [messageBoxTopVh, setMessageBoxTopVh] = (0, import_react7.useState)(isVerticalLayout ? 50 : 60);
  const [loading, setLoading] = (0, import_react7.useState)(false);
  const isLoading = loading || externalLoading;
  const messageBoxRef = (0, import_react7.useRef)(null);
  const [isEditingMessage, setIsEditingMessage] = (0, import_react7.useState)(false);
  const [editedMessage, setEditedMessage] = (0, import_react7.useState)("");
  const [originalMessage, setOriginalMessage] = (0, import_react7.useState)("");
  const [localSkit, setLocalSkit] = (0, import_react7.useState)(skit);
  const scriptEntries = (0, import_react7.useMemo)(() => localSkit?.script ?? [], [localSkit]);
  const [index, setIndex] = (0, import_react7.useState)(skit?.currentIndex ?? -1);
  const prevIndexRef = (0, import_react7.useRef)(index);
  const prevTypingIndexRef = (0, import_react7.useRef)(index);
  const prevExternalLoadingRef = (0, import_react7.useRef)(externalLoading);
  const accentMain = theme.palette.primary.main;
  const accentLight = theme.palette.primary.light;
  const errorMain = theme.palette.error.main;
  const errorLight = theme.palette.error.light;
  const getColorFromScheme = (colorScheme) => {
    const schemeMap = {
  ...
  const baseTextShadow = (0, import_react7.useMemo)(
    () => `2px 2px 2px ${safeAlpha(theme.palette.common.black, 0.8)}`,
    [theme]
  );
  const messageTokens = (0, import_react7.useMemo)(
    () => ({
      baseTextShadow,
  ...
  const actorsAtIndex = (0, import_react7.useMemo)(() => {
  ...
  const focusActor = (0, import_react7.useMemo)(() => {
  ...
  const popInSpeakerSide = (0, import_react7.useMemo)(() => {
  ...
  const actorTheme = (0, import_react7.useMemo)(() => {
  ...
  const displayMessage = (0, import_react7.useMemo)(() => {
  ...
  const placeholderText = (0, import_react7.useMemo)(() => {
